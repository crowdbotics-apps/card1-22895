...
admin.site.site_header = "card1"
admin.site.site_title = "card1 Admin Portal"
admin.site.index_title = "card1 Admin"

# swagger
api_info = openapi.Info(
    title="card1 API",
    default_version="v1",
    description="API documentation for card1 App",
)
